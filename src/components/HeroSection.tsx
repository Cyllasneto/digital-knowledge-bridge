...
export const HeroSection = () => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center gradient-bg text-white">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center animate-fade-up">
        ...
        <Button className="bg-white text-primary-dark hover:bg-primary-light hover:text-white text-lg px-8 py-6">
